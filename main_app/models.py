...
class Post(models.Model):
    ...
    image_upload = models.FileField(blank=True, null=True, upload_to="models/%Y/%m/$D/")
    image_link = models.CharField(max_length=2000, default=None, blank=True, null=True )
